...
assert(source.includes("male-east-west-candidate-0.1.json"), '0.4 does not load the saved east/west candidate.');
...
assert(candidate.poses.walk4.farUpperArm === 24 && candidate.poses.walk4.farForearm === 29, '0.4 source candidate does not include the corrected Walk 4 arm.');

console.log('Hero Animation Lab 0.4 east/west validation smoke checks passed.');
