...
assert(html.includes('Hero Animation Lab <span>0.5.1</span>'), 'Hero Animation Lab page was not advanced to 0.5.1.');
...
console.log('Hero Animation Lab 0.5.1 draggable-joint and grouped-control smoke checks passed.');
