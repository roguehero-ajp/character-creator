...
if(p<1)return;
const sc=Math.min(p,MAX_PULL)/p,b=(steroidTimer > 0 ? 1.42 : 1) * (window.JMPowerUps?.getThrowMultiplier() ?? 1),h=held(),vx=dx*sc*F.throwScale*b,vy=dy*sc*F.throwScale*b,g=GRAVITY*F.gravityMultiplier;
