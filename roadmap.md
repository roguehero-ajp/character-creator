...
- [x] Complete SRD background collections
...
- [x] Rules, character origins, backgrounds, feats, class foundations, mundane equipment, spells, and magic items in one searchable page
- [x] Game-system, edition, entry-type, rule-category, race/species-category, and equipment-category filters, including a dedicated Classes collection
...
- [x] SRD subclass identity and subclass-feature levels
- [x] Automated synchronization checks against the builder class data
- [~] Final class-by-class mechanical and editorial audit

## Remaining Codex collections

- [x] SRD backgrounds and feats
- [x] SRD class foundations and progression tables
- [ ] Individual class-feature entries
- [ ] SRD subclasses and subclass-feature entries
...
1. Add individual class-feature entries.
2. Add subclasses and subclass-feature collections.
3. Begin the edition-aware builder class architecture branch using the validated Codex foundations.
...
6. Add subclass selection and combined spell-slot handling.
